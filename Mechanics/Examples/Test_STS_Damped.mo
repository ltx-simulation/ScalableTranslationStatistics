...
model Test_STS_Damped
  ...
  Mechanics.Model.STS_Damped scalableModelicaModel(
    c=100,
    d=d,
    c_stiff=c_stiff,
    num_Inp=Nin,
...
This model <a href=\"modelica://ScalableTranslationStatistics.Mechanics.Model.STS_Damped>\"ScaleTranslationStatistics_Damped</a> is fed with arbitrarily defined input signals. The spring chains have a damper in parallel to reach a steady state at constant forces</li>
</html>"));
end Test_STS_Damped;

...
<p>The model <a href=\"modelica://ScalableTranslationStatistics.Mechanics.Model.ScaleTranslationStatistics>\"ScaleTranslationStatistics</a> is fed with arbitrarily defined input signals.<br> Physically this means to apply forces on the masses.</p>

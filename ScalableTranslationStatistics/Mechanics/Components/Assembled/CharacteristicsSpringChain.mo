...
<p>builds a chain of <a href=\"modelica://ScalableTranslationStatistics.Mechanics.Components.Subcomponents.DiscreteStiffnessSpring\">springs with characteristics</a> in a row </p>

...
This model extends <a href=\"modelica://ScalableTranslationStatistics.Mechanics.Model.STS_ControlledDelay>\"Control Loop Example with Delay </a>: The inputs of the model also depends on former outputs of the model (more than a integrator step size ago) </li>
</html>"));

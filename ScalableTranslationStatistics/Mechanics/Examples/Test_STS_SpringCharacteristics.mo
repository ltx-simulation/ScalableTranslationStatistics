...
model Test_STS_SpringCharacteristics
  ...
  Mechanics.Model.STS_springCharacteristics scalableModelicaModel(
    c=100,
    c_stiff=c_stiff,
...
The model <a href=\"modelica://ScalableTranslationStatistics.Mechanics.Model.STS_SpringCharacteristics>\"SpringCharacteristics </a> is fed with arbitrarily defined input signals. The stiffness of the springs in the spring-chains between the masses must be read from a file and can be nonlinear or even discontinuous</li>
</html>"));

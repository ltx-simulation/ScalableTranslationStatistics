...
<p>builds a chain of <a href=\"modelica://ScalableTranslationStatistics.Components.Subcomponents.NonlinearSpring\">nonlinear springs</a> in a row with alternating stiffness (c_1, c_2) of the single springs</p>

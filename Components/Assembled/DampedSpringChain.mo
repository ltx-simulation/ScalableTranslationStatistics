...
<p> extends the <a href=\"modelica://ScalableTranslationStatistics.Components.Assembled.NonLinearSpringChain\">nonlinear spring chain </a> by adding a damper in parallel to the whole spring chain</p>
</html>"));

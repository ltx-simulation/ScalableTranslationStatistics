...
<p>function to calculate the initial force of a spring with discrete stiffness steps, if the unstreched length of the spring is not zero. The function is only used for the initialization of <a href=\"modelica:\\\\ScalableTranslationStatistics.Components.Subcomponents.DiscreteStiffnessSpring\">DiscreteStiffnessSprings</a>. </p>
</html>"));
end InitialForce;

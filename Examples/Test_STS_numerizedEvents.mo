...
model Test_STS_numerizedEvents
  ...
  Model.STS_numerizeEvents scalableModelicaModel(
    c=100,
    c_stiff=c_stiff,
...
This model <a href=modelica://ScalableTranslationStatistics.Model.STS_numerizeEvents>numerizeEvents</a>  is fed with arbitrarily defined input signals. Parametrizable number of events per second simulation time; realized by turning on and off to apply a force on the single mass in the small system</li>
</html>"));

...
model Test_STS_DiscreteSpring
  ...
  Model.STS_DiscreteSpring scalableModelicaModel(
    c=100,
    c_stiff=c_stiff,
...
This model <a href=modelica://ScalableTranslationStatistics.Model.STS_DiscreteSpring>DiscreteSpring </a> is fed with arbitrarily defined input signals. The stiffness of the spring in the small (stiff) system changing discretely</li>
</html>"));

...
This model extends <a href=modelica://ScalableTranslationStatistics.Model.STS_Controlled>Control Loop Example </a>: The inputs of the model also depends on the outputs </li>
</html>"));
